...
- `ID_Tools.selectOperatorEvidence` — Requests operator evidence selection without function tools or agent transitions.
  Directory: functions/ID_Tools/selectOperatorEvidence/
